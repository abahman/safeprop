...
## Issue tracker
safeprop uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [safeprop boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [ahjortland/safeprop/issues][issues].
...
### Write Documentation
CoolProp Wrappers for Safe Property Evaluation could always use more documentation, whether as part of the official CoolProp Wrappers for Safe Property Evaluation docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `CoolProp Wrappers for Safe Property Evaluation` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [ahjortland/safeprop][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/safeprop.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on safeprop coding standards.
...
[issues]: https://github.com/ahjortland/safeprop/issues
[repo]: https://github.com/ahjortland/safeprop
[repo-boards]: https://github.com/ahjortland/safeprop/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/ahjortland/safeprop/pull_requests
